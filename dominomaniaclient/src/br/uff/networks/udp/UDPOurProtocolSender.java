...
public class UDPOurProtocolSender implements UDPWelcomeSocketSender{
    ...
    UDPOurProtocolSender(byte[] ip,int portToSend,int portToListen) throws UnknownHostException, SocketException{
        sender=new UDPSenderSendWait(ip, portToSend, portToListen);
    }

    public UDPOurProtocolSender(int portToListen) throws SocketException {
        sender=new UDPSenderSendWait(portToListen);
    }
